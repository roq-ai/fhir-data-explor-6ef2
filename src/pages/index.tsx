...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`FHIR Data Explorer`}</title>

        <meta
          name="description"
          content="Experience seamless healthcare data management with FHIR Data Explorer - Efficiently view, search, and analyze patient data in FHIR format. Designed for healthcare professionals and administrators, we aim to streamline workflows, improve patient care, and ensure data security and compliance with healthcare standards."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxoZWFsdGhjYXJlfGVufDB8fHx8MTY5MzgzMjk3OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless healthcare data management with FHIR Data Explorer - Efficiently view, search, and analyze patient data in FHIR format. Designed for healthcare professionals and administrators, we aim to streamline workflows, improve patient care, and ensure data security and compliance with healthcare standards.`}
            </Text>
            <Box
