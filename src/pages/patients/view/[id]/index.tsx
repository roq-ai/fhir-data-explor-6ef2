...
import { EncounterListPage } from 'pages/encounters';
import { MedicationListPage } from 'pages/medications';
import { ObservationListPage } from 'pages/observations';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  label="Dob"
                  text={data?.dob ? format(parseISO(data?.dob as unknown as string), 'dd-MM-yyyy') : ''}
                />
