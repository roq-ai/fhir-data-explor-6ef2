...
import { getMedicationById } from 'apiSdk/medications';
import { MedicationInterface } from 'interfaces/medication';

function MedicationViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('medication', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/medications/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Dosage" text={data?.dosage} />

                <FormListItem label="Instructions" text={data?.instructions} />

                <FormListItem label="Dispensing Details" text={data?.dispensing_details} />
