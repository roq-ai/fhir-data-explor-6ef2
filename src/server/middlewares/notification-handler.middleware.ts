...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'patient.create': {
    roles: ['healthcare-professional', 'practitioner', 'administrator'],
    key: 'patient-record-created',
    tenantPath: ['organization', 'patient'],
    userPath: [],
  },
  'patient.update': {
    roles: ['healthcare-professional', 'practitioner', 'administrator'],
    key: 'patient-record-updated',
    tenantPath: ['organization', 'patient'],
    userPath: [],
  },
  'patient.delete': {
    roles: ['healthcare-professional', 'practitioner', 'administrator'],
    key: 'patient-record-deleted',
    tenantPath: ['organization', 'patient'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['healthcare-professional', 'administrator', 'practitioner'];
